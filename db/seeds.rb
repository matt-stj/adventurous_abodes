...
Rental.create(name: "Jetskiing", description: "Fun in the sun!", price: 150)
Rental.create(name: "Skiing", description: "Powder snow in the Alps", price: 750)
Rental.create(name: "Hiking", description: "South America tour through Argentina & Chile", price: 1150)
